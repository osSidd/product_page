...
export default function HeroBanner(){
    return (
        <section className='md:flex items-center justify-between bg-blue-400 pr-6 pl-14 pb-6 pt-24'>
            ...
            <img className=' md:w-6/12' src={heroImg} alt="hero image running sneakers" />
        </section>
    )
}